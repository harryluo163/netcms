function bannerGd2(id,width){
	
	var obj = document.getElementById(id);
	var oUl = obj.getElementsByTagName("ul")[0];
	var aLi = oUl.getElementsByTagName("li");
	oUl.style.width = parseInt(aLi.length)*parseInt(width)+"px";
	
	STK2.register("kit.dom.parseDOM", function(a) {
	    return function(c) {
	        for (var b in c) {
	            if (c[b] && (c[b].length == 1)) {
	                c[b] = c[b][0]
	...
	STK2.register("common.app.slider", function(f) {
	...
	STK2.register("comp.app.focus", function(f) {
	...
	STK2.pageletM.register("pl.app.focus", function(b) {
	    var a = b.E(id);
	    b.comp.app.focus(a)
	});
	STK2.pageletM.start();
