<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="case_nr.aspx.cs" Inherits="DTcms.Web.aspx.main.case_nr" %>
...
<html>
	...
	<body>
			...
			<div id="caseType">
				...
				<div class="caseWarpBox">
					<ul class="clearfix">
						...
						<li>
							<a class="<%#Eval("id").ToString()==model.category_id.ToString()?"active":""  %>" href="/<%#GetUrl(Convert.ToInt32(Eval("id"))) %>/<%#Eval("id") %>.html" ><%#Eval("title") %></a>
					...
					<div class="goodInfoImg clearfix">
                        ...
                        <div style="position: relative; top: 0; left: 0; width: 640px; height: 456px; overflow: hidden; float: left;">
						    <div id="goodImg">
                                ...
                                <b><img src="<%#Eval("original_path") %>"/></b>
        ...
        <script>
            //$(function () {
            //    var img_url = $("#goodImgList ul li:first img").attr("src");
            //    $("#goodImg img").attr("src", img_url);
            //})
            //function getval(remark)
            //{
            //    $("#remark").html(remark);
            //}
        </script>
