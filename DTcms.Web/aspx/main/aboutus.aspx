<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="aboutus.aspx.cs" Inherits="DTcms.Web.aspx.main.aboutus" %>
...
<html>
	...
	<body>
		...
		<div id="content" class="clearfix">
			<ul class="aboutNav">
				<li><a href="/aboutus.html" class="active">公司介绍</a></li>
			...
			<div id="aboutCont">
				<h2>公司介绍&nbsp;&nbsp;Company introduction</h2>
				<div class="imgBox">
