...
{
    public partial class _case : BasePage
    {
        ...
        private void Display()
        {
            ...
            //绑定页码
            string pageUrl = "/case/" + category_id + "/__id__.html";

            string whereStr = "status=0";

            //bll.GetList("goods", category_id, pageSize, pageIndex, whereStr, "sort_id asc,id desc", out recordCount);
            DataSet ds = bll.GetList("goods",category_id, 100, whereStr, "sort_id asc,id desc");
            RepBindPic2.DataSource = ds;
            RepBindPic2.DataBind();
            RepBindPic.DataSource = ds;
            RepBindPic.DataBind();
