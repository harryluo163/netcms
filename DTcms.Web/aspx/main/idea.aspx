<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="idea.aspx.cs" Inherits="DTcms.Web.aspx.main.idea" %>
	...
	<body>
		...
		<div id="content" class="clearfix">
			<ul class="aboutNav">
				...
				<li><a href="/idea.html" class="active">久佳理念</a></li>
				<li><a href="/equipment.html">生产车间及设备</a></li>
			</ul>
			<div id="aboutCont">
				
				<h2>久佳理念&nbsp;&nbsp;JIUJIA idea</h2>
				<div class="imgBox">
