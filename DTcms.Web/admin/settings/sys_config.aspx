...
<script type="text/javascript">
    $(function () {
        //初始化表单验证
        $("#form1").initValidform();
        $(".upload-img").InitUploader({ filesize: "<%=siteConfig.imgsize %>", ater: true, sendurl: "../../tools/upload_ajax.ashx", water: true, swf: "../../scripts/webuploader/uploader.swf", filetypes: "<%=siteConfig.fileextension %>" });
...
<div class="tab-content">
  ...
  <dl>
    <dt>地图坐标</dt>
    <dd>
      <asp:TextBox ID="webmap" runat="server" CssClass="input normal" />
    </dd>
  </dl>
  <dl>
    <dt>客服电话</dt>
...
<div class="tab-content" style="display:none">
  ...
  <dl style="display:none">
    <dt>图片水印文件</dt>
    <dd>
      <asp:TextBox ID="watermarkpic" runat="server" CssClass="input txt" sucmsg=" " />
    ...
    <dt>图片水印文件</dt>
    <dd>
   <asp:TextBox ID="txtImgUrl" runat="server" CssClass="input normal upload-path"   sucmsg=" " />
